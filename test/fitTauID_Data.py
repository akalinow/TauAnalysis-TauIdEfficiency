...
againstMuonLoose3_Data.BinToPDFmap = cms.vstring("Data_Model_LooseEta0","*abseta_bin1*","Data_Model_LooseEta1", "*abseta_bin2*","Data_Model_LooseEta2")

againstMuonTight3_Data = efficiencyPSetTemplate.clone()
againstMuonTight3_Data.BinToPDFmap = cms.vstring("Data_Model_TightEta0","*abseta_bin1*","Data_Model_TightEta1", "*abseta_bin2*","Data_Model_TightEta2")
