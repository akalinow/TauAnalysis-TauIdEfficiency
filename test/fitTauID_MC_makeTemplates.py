...
Zmumu_Model = cms.vstring(
    ...
    "Voigtian::signal2Fail(mass, mean2Fail[92, 85,95], width[2.495], sigma2Fail[3, 2,5])",
    "SUM::signalFail(vFracFail[0.9, 0,1]*signal1Fail, signal2Fail)",
    
    "Voigtian::signal1Pass(mass, mean1Pass[92, 85,95], width[2.495], sigma1Pass[2, 1,5])",
...
Ztautau_Model = cms.vstring(
    ...
    "Exponential::backgroundPass1(mass, lp1[-0.033, -1,0.1])",
    ...
    "Exponential::backgroundFail1(mass, lf[-0.039, -1, 0.1])",
...
process.TnP_Muon_ID = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    Variables = cms.PSet(
        ...
        pair_MTtag = cms.vstring("MTprobe", "0", "40", ""),
