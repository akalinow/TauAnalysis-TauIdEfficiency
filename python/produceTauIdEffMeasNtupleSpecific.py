...
def produceTauIdEffMeasNtuple(process, isMC, HLTprocessName, pfCandidateCollection, applyZrecoilCorrection):

    # produce PAT objects from which Ntuple branches are extracted
    patTupleConfig = produceTauIdEffMeasPATTuple_base(process, isMC, HLTprocessName, pfCandidateCollection, applyZrecoilCorrection)
    ...
    #--------------------------------------------------------------------------------
    #
    # MV: modify content of Ntuple branch extractors
    #        
