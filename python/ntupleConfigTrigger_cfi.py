...
trigger_template = cms.PSet(
    ...
    columns = cms.PSet(
        ...
        hltJet70Ubit         = cms.string("HLT_Jet70U:bit"),
        hltJet70Uprescale    = cms.string("HLT_Jet70U:prescale"),                                    
        hltJet100Ubit        = cms.string("HLT_Jet100U:bit"),
        hltJet100Uprescale   = cms.string("HLT_Jet100U:prescale"),
    ...
    l1Seeds = cms.PSet(
        ...
        HLT_Jet70U  = cms.string("L1_SingleJet40U"),
        HLT_Jet100U = cms.string("L1_SingleJet60U"),
