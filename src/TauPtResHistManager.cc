...
{
  histogramTauPtRes_                  = book1D(dir, "tauPtRes",                  "tauPtRes",                               100, 0., 5.);
  histogramTauPtResGenOneProng0Pi0_   = book1D(dir, "tauPtResGenOneProng0Pi0",   "tauPtRes (gen. one-prong, 0 #pi^{0})",   100, 0., 5.);
  histogramTauPtResGenOneProng1Pi0_   = book1D(dir, "tauPtResGenOneProng1Pi0",   "tauPtRes (gen. one-prong, 1 #pi^{0})",   100, 0., 5.);
  histogramTauPtResGenOneProng2Pi0_   = book1D(dir, "tauPtResGenOneProng2Pi0",   "tauPtRes (gen. one-prong, 2 #pi^{0})",   100, 0., 5.);
  histogramTauPtResGenThreeProng0Pi0_ = book1D(dir, "tauPtResGenThreeProng0Pi0", "tauPtRes (gen. three-prong, 0 #pi^{0})", 100, 0., 5.);
  histogramTauPtResGenThreeProng1Pi0_ = book1D(dir, "tauPtResGenThreeProng1Pi0", "tauPtRes (gen. three-prong, 1 #pi^{0})", 100, 0., 5.);

  histogramJetPtRes_                  = book1D(dir, "jetPtRes",                  "jetPtRes",                               100, 0., 5.);
  histogramJetPtResGenOneProng0Pi0_   = book1D(dir, "jetPtResGenOneProng0Pi0",   "jetPtRes (gen. one-prong, 0 #pi^{0})",   100, 0., 5.);
  histogramJetPtResGenOneProng1Pi0_   = book1D(dir, "jetPtResGenOneProng1Pi0",   "jetPtRes (gen. one-prong, 1 #pi^{0})",   100, 0., 5.);
  histogramJetPtResGenOneProng2Pi0_   = book1D(dir, "jetPtResGenOneProng2Pi0",   "jetPtRes (gen. one-prong, 2 #pi^{0})",   100, 0., 5.);
  histogramJetPtResGenThreeProng0Pi0_ = book1D(dir, "jetPtResGenThreeProng0Pi0", "jetPtRes (gen. three-prong, 0 #pi^{0})", 100, 0., 5.);
  histogramJetPtResGenThreeProng1Pi0_ = book1D(dir, "jetPtResGenThreeProng1Pi0", "jetPtRes (gen. three-prong, 1 #pi^{0})", 100, 0., 5.);
...
void TauPtResHistManager::fillHistograms(const pat::Tau& patTau, const reco::GenParticleCollection& genParticles, double weight)
{
  ...
  double tauPtRes = (recTauPt - genVisPt)/genVisPt;
  ...
  double jetPtRes = (recJetPt - genVisPt)/genVisPt;
